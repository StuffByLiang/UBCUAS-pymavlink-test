...
class Telemetry():
    ...
    def init_data_streams(self):
        ...
        self.set_message_interval(24, 2) # gps
        self.set_message_interval(33, 2) # gps
        self.set_message_interval(0,  2) # heartbeat
        self.set_message_interval(74, 2) # vfr_hud
    ...
    def set_message_interval(self, messageid, interval):
        ...
        self.mavlink_connection.mav.command_long_send(
            ...
            int(millseconds), # interval in us
            0,
            0,
            0,
            0,
        ...
        try:
            while True:
                ...
                while True:
                    try:
                        # try to get message
                        msg = self.mavlink_connection.recv_msg() # RECIEVES THE MESSAGE
